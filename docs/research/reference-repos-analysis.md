...
**Path:** `<workspace>/Playables/playable-template`
...
**Path:** `<workspace>/Playables/super-html`
...
**Path:** `<workspace>/playbox-platform/packages/plbx-cli`
...
**Path:** `<workspace>/playbox-platform/packages/shared/toolkit`
