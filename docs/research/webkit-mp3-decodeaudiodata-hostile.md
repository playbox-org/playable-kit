...
`src/packager/loader/assets.ts` (`plbx_install_shims`) wraps
...
`src/packager/audio-format-check.ts`: `isHostileMp3` / `detectHostileMp3`
...
Covered by `tests/packager/audio-format-check.test.ts`.
